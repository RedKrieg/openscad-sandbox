...
module mirror_image() {
    mirror([0, 0, 1]) translate([0, 0, png_invert ? logo_thickness : 0]) scale([png_scale, png_scale, 1/100*logo_thickness]) surface(png_filename, center=true, invert=png_invert);
}
